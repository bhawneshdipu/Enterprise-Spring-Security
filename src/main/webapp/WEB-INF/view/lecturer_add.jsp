...
<body>
	...
	<h2 class="text-center">Lecturer ADD</h2>


	<div class='col-lg-8 col-md-offset-2'>
		<form class="form-horizontal" action="/admin/lecturer/add" method="post">
			<div class="form-group">
				<label class="control-label col-sm-2" for="fname">Gname</label>
				<div class="col-sm-10">
