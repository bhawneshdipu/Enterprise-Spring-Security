...
<body>
	...
	<h2 class="text-center">Assessment Edit</h2>


	<div class='col-lg-8 col-md-offset-2'>
		<form class="form-horizontal"
			action="/lecturer/assessment/edit/${sessionScope.assessment.eid}"
			method="post">
					...
					<select class="form-control" id="sid" name="sid">
						<c:forEach var="student" items="${studentList}">
							<option value="${student.sid}"
								${student.sid == sessionScope.assessment.sid ? 'selected="selected"' : ''}>${student.fname}
